...
const LogoWrapper = styled.div`
  ${tw`bg-gray-800 w-screen h-screen grid justify-center items-center overflow-hidden`}
  div {
    ${tw`w-64`}
  }
`;
      ...
      <div>
        <Logo>
          ...
          >
            ...
            />
            <motion.path fill="#00bff3" d="M213.09 450h750v600h-150V600h-450v600h-150V450z" variants={pathVariants2} />
          </motion.svg>
        </Logo>
      </div>
    </LogoWrapper>
